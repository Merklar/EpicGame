package hero.mage
{
	...
	public class M_Kriomant extends Warrior
	{
		
		private var arrow:Fireball;
		private var arrowU:FireballKrio;
		private var dif:Number;
		private var ultimateAttackPower:uint;
		private var dotDamageTime:uint = 6;
		
		public function M_Kriomant()
		{
			super();
			name = "kriomant";
			discriptionName = "Криомант";
			...
			hpClean = hp = hp_max;
			this.hpText.text = hp;
			ultimateName = "kriomant";
			price = 250;
			exp = 750;
			passiveDiscription = "Пассивной способности не имеет";
			ultimateDiscription = "Пускает ледяной шар, наносящий едино разово массовый урон и замораживающий врага на некоторое время";
			ultimate = false;
			ultimateReady = true;
			ultimateReadyKD = 10;
		...
		public override function update():void
		{
			...
			if (ultimate == true)
			{
				arrowU = new FireballKrio(ultimateAttackPower, dotDamageTime, hitHeightAttack, this);
